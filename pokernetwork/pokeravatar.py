...
#       self.message("instance deleted")
    ...
    def getPlayerStats(self, table, serialSought):
        if self.user.isLogged():
            return self.service.getUserStatsLookup().getAttrsAsPacket(table, serialSought)
        else:
    ...
    def join(self, table):
        ...
        for player in game.serial2player.values():
            ...
            self.sendPacketVerbose(self.service.getUserStatsLookup().getAttrsAsPacket(table, player.serial))
