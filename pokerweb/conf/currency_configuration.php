...
$GLOBALS['currency_db_persist'] = TRUE;
$GLOBALS['currency_db_host'] = "localhost";
$GLOBALS['currency_db_port'] = 3306;
$GLOBALS['currency_db_base'] = "currency";
$GLOBALS['currency_db_user'] = "currency";
$GLOBALS['currency_db_password'] = "currency";

$GLOBALS['currency_random'] = "/dev/urandom";

$GLOBALS['currency_url'] = "http://localhost/currency/";

$GLOBALS['currency_values'] = array(1, 2, 5,
                                    10, 20, 50,
                                    100, 200, 500,
                                    1000, 2000, 5000,
                                    10000, 20000, 50000,
