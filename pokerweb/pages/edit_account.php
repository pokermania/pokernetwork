 ...
 <!-- ACCOUNT INFORMATION FORM -->
	<form method="post" enctype="multipart/form-data">
		<table>
			...
			<tr>
				<td><b><?php echo _('New password') ?><sup>*</sup>:</b></td>
				<td><input type="password" size="20" maxlength="32" id="password2" name="password2" /></td>
			</tr>
			<tr>
				<td><b><?php echo _('New Password confirmation') ?><sup>*</sup>:</b></td>
...
?>
			...
			<tr>
				<td></td>
				<td>
                                        <img src="image.php?serial=<?php print $serial ?>" />
					<b><?php echo _('Avatar') ?>: <input type="file" name="image"></b><br />
				<td></td>
				<td>
