...
class PokerExplainTestCase(unittest.TestCase):
    ...
    def test27_explain_player_leave(self):
        ...
        player_serial = 3
        self.failUnless(game.addPlayer(player_serial, 1))
        self.assertTrue(self.explain.explain(PacketPokerPlayerLeave(
            game_id = game_id,
            serial = player_serial
        )))
        self.assertEqual(2, len(self.explain.forward_packets))
    ...
    def test27_explain_table_move(self):
        ...
        player_serial = 3
        self.failUnless(game.addPlayer(player_serial, 1))
        self.assertTrue(self.explain.explain(PacketPokerTableMove(
            game_id = game_id,
    ...
    def test27_explain_player_self_leave(self):
        ...
        self.assertTrue(self.explain.explain(PacketPokerPlayerLeave(game_id = game_id, serial = player_serial)))
        self.assertNotEqual(False, self.explain.games.getGame(game_id))        
    ...
    def test28_explain_player_self(self):
        ...
        self.assertTrue(self.explain.explain(PacketPokerPlayerSelf(game_id = game_id, serial = player_serial)))
    ...
    def test34_explain_in_game(self):
        ...
        self.assertTrue(self.explain.explain(PacketPokerInGame(game_id = game_id, players = [player_serial])))
        self.assertEqual(3, len(self.explain.forward_packets))
        ...
        #
        self.assertTrue(self.explain.explain(PacketPokerInGame(game_id = game_id, players = [])))
        self.assertEqual(2, len(self.explain.forward_packets))
        self.assertEqual(PACKET_POKER_IN_GAME, self.explain.forward_packets[0].type)
    ...
    def test41_explain_state_flop_hand_strength(self):
        ...
        self.assertEqual('Flush Nine high: 9h, 8h, 7h, 4h, 3h', self.explain.forward_packets[1].hand)
