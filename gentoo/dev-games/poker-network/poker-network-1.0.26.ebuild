...
DEPEND=">=sys-devel/automake-1.9.0 dev-util/pkgconfig >=dev-lang/python-2.4.0 dev-python/soappy dev-python/mysql-python dev-python/pygtk dev-python/twisted dev-util/glade dev-libs/glib dev-games/poker-engine dev-games/pypoker-eval net-misc/rsync"
