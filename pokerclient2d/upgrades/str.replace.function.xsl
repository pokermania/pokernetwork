<?xml version="1.0"?>
<!-- Author:  Jeni Tennison <mail@jenitennison.com>
     URL: http://www.exslt.org/str/functions/replace/str.replace.template.xsl
     As of 2005/09 this function is distributed as a standalone code snippet 
     without an associated license or copyright notice. -->
