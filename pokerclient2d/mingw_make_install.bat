...
type data\interface\table\mockup.svg | %PYTHONROOT%\python.exe data\svg2gtk.py --glade > data\interface\table\mockup.glade
type data\interface\table\mockup.svg | %PYTHONROOT%\python.exe data\svg2gtk.py --gtkrc > data\interface\table\gtkrc.mockup
